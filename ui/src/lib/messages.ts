// central NUI message router, forwards SendNUIMessage calls from client/*.lua to the menu store

import { handleMenuMessage } from './store/menu.svelte';
